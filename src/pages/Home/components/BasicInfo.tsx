    ...
    <div className="max-w-7xl mx-auto w-full flex flex-col items-start px-2 xs:px-2 sm:px-4 md:px-8 lg:px-24">
      ...
      <div className="flex flex-col md:flex-row items-start justify-start">
        ...
        <div className="md:w-2/3">
          <h2 className="font-bold text-sm xs:text-sm sm:text-md md:text-lg lg:text-xl">
            {firstName} {lastName}
          </h2>
          <p className="mb-4">Birth Year: {birthYear}</p>
          <div className="mb-4">
            <h3 className="font-bold text-sm xs:text-sm sm:text-md md:text-lg lg:text-xl">
              Profession:
            </h3>
          ...
          <div className="mb-4">
            ...
            <p className="text-xs xs:text-xs sm:text-sm md:text-md lg:text-md">
              {languages.join(", ")}
            </p>
          </div>
        </div>
