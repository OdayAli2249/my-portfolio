...
export const projects: Project[] = [{
    ...
    gallery: [
        ...
        { src: 'https://odayali2249.github.io/portfolio-resources/resources/sc/sc-demo-1.mp4', type: 'video', highlightWord: 'Demo(1): Rigid Body Simulator', tag: 2 },
        ...
        { src: 'https://odayali2249.github.io/portfolio-resources/resources/sc/sc-demo-2.mp4', type: 'video', highlightWord: 'Demo(2): Rigid Body Simulator - Add wind Effect in X axis', tag: 2 },
    ...
    options: [
        { icon: '/profile_1.png', label: 'Code', actionType: 'LINK', link: 'https://github.com/OdayAli2249/poly-dynamics-2D' },
        { icon: '/profile_1.png', label: 'Demo', actionType: 'LINK', link: 'https://github.com/OdayAli2249/poly-dynamics-2D' },
        { icon: '/profile_1.png', label: 'Details', actionType: 'DEFAULT' },
    ]
},
{
    id: 2,
    type: 'video',
    mediaUrl: '/ms/ms-demo-1.mp4',
    ...
    gallery: [
        { src: '/ms/1.jpg', type: 'image', highlightWord: 'Image(1): Ultimate Mines Weeper Game', tag: 1 },
        { src: '/ms/2.jpg', type: 'image', highlightWord: 'Image(2): Ultimate Mines Weeper Game', tag: 1 },
        { src: '/ms/ms-demo-1.mp4', type: 'video', highlightWord: 'Demo(1): Ultimate Mines Weeper Game', tag: 1 },
        { src: '/ms/menu.jpg', type: 'image', highlightWord: 'Image(3): Ultimate Mines Weeper - Dashboard', tag: 1 },
        { src: '/ms/ms-demo-3.mp4', type: 'video', highlightWord: 'Demo(2): Ultimate Mines Weeper Game', tag: 1 },
        { src: '/ms/3.jpg', type: 'image', highlightWord: 'Image(4): Ultimate Mines Weeper Game', tag: 1 },
        { src: '/ms/4.jpg', type: 'image', highlightWord: 'Image(5): Ultimate Mines Weeper Game', tag: 1 },
        { src: '/ms/5.jpg', type: 'image', highlightWord: 'Image(6): Ultimate Mines Weeper Game', tag: 1 },
    ],
    linksTitle: 'Links:',
    links: [
        {
